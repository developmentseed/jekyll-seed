...
- [ ] On `_config.yml` and `_includes/meta.html` update the project title and check for other boostrap information that can be changed or removed.
...
## Gulp for building
The gulpfile is based on the [project-seed](http://github.com/developmentseed/project-seed). The build system currently supports:
